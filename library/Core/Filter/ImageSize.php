...
/**
 * @see Core_Filter_ImageSize_Strategy_Fit
 */
require_once 'Core/Filter/ImageSize/Strategy/Fit.php';
 ...
 */
class Core_Filter_ImageSize implements Zend_Filter_Interface
{
    /**
    ...
    /**
     * Resizing strategy.
     * @var Core_Filter_ImageSize_Strategy_Interface
     */
     ...
     * @return Core_Filter_ImageSize Fluent interface
     */
     ...
     * @param Core_Filter_ImageSize_Strategy_Interface $strategy
     * @return Core_Filter_ImageSize Fluent interface
     */
    public function setStrategy(Core_Filter_ImageSize_Strategy_Interface $strategy)
    {
     ...
     * @return Core_Filter_ImageSize_Strategy_Interface
     */
    public function getStrategy()
    {
        if(is_null($this->_strategy)) {
            $this->_strategy = new Core_Filter_ImageSize_Strategy_Fit();
        }
